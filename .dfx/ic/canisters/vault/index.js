...
export const canisterId = process.env.CANISTER_ID_VAULT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./vault.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the vault canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./vault.did.js")._SERVICE>}
 */
export const vault = createActor(canisterId);
