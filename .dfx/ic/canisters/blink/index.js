...
import { idlFactory } from './blink.did.js';
export { idlFactory } from './blink.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BLINK;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./blink.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the blink canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./blink.did.js")._SERVICE>}
 */
export const blink = createActor(canisterId);
